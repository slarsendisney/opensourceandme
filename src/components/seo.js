...
const SEO = ({ description, title, image, location }) => {
  ...
  return (
    <Helmet>
      <title>OpenSourceAnd.Me | {title} </title>
      <meta name="title" content={`${title} | OpenSourceAnd.Me `} />
      <meta name="description" content={metaDescription} />
      <link rel="canonical" href={url} />
      <meta property="og:type" content="website" />
      <meta property="og:url" content={url} />
      <meta property="og:title" content={`${title} | OpenSourceAnd.Me `} />
      <meta property="og:description" content={metaDescription} />
      <meta property="og:image" content={metaImage} />

      <meta name="twitter:card" content="summary_large_image" />
      <meta name="twitter:creator" content="OpenSourceAnd.Me" />
      <meta name="twitter:title" content={`${title} | OpenSourceAnd.Me `} />
